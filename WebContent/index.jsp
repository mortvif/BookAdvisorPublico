...
<div class="wrapper row0 bgded" style="background-image:url('images/portrait_book.jpeg');">
            ...
            <c:forEach items="${books}" var="book" varStatus="loop">
                ...
                <c:if test="${loop.index > 0 }">
	                ...
	                <article class="block">
					    ...
					    <a href="javascript:;" onclick="parentNode.submit();"><img class="recomendados" src="images/covers/${book.getCoverPath()}" alt="Libro 1"></a>
