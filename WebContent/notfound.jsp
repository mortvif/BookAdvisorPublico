	...
	<div class="wrapper row3">
		...
		<div class="content ">
			...
			<div class="result two_third first">
				<div>
					<p style="color: red; font-size: 16px;">La búsqueda no ha
						devuelto resultados. Pruebe a refinarla con la búsqueda avanzada</p>
					<c:if test="${user != null}">
						<p style="color: red; font-size: 16px;">también puede crear el
							libro si lo desea. Haga click "Añadir libro" para agregarlo.</p>
						<br>
			...
			<div class="one_third">
				...
				<p>Para que la búsqueda sea más precisa rellene el mayor número
					de campos posibles</p>
				<div>
